 ...
 * specified {@link SelectCitiesFragment.OnEditCitiesListEndListener}.
...
public class SelectCityRecyclerViewAdapter
    ...
    private final SelectCitiesFragment.OnEditCitiesListEndListener mListener;

    public SelectCityRecyclerViewAdapter(List<CitiesItemField> items,
                                         SelectCitiesFragment.OnEditCitiesListEndListener listener) {
        mListener = listener;
        mValues = items;
    }
